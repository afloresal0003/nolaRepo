...
export class LevelThreequestion1Page implements OnInit {
  ...
  showColor(color, num){
    const qResult1 = document.getElementById('l3q1result1');
    const qResult2 = document.getElementById('l3q1result2');
    const qHint2 = document.getElementById('l3q1hint2');
    const qResult3 = document.getElementById('l3q1result3');
    const qHint3 = document.getElementById('l3q1hint3');
    const qResult4 = document.getElementById('l3q1result4');
    const qHint4 = document.getElementById('l3q1hint4');
    const nextB = document.getElementById('l3q1nextButton');
    const emoji = document.getElementById('l3q1emoji');
    const message = document.getElementById('l3q1message');
    const preUpdate = document.getElementById('l3q1numberTroph');
    const postUpdate = document.getElementById('l3q1trophUpdate');
  ...
  hideColor(option){
    const qContainer1 = document.getElementById('l3q1answer1');
    const qResult1 = document.getElementById('l3q1result1');
    const qContainer2 = document.getElementById('l3q1answer2');
    const qResult2 = document.getElementById('l3q1result2');
    const qHint2 = document.getElementById('l3q1hint2');
    const qContainer3 = document.getElementById('l3q1answer3');
    const qResult3 = document.getElementById('l3q1result3');
    const qHint3 = document.getElementById('l3q1hint3');
    const qContainer4 = document.getElementById('l3q1answer4');
    const qResult4 = document.getElementById('l3q1result4');
    const qHint4 = document.getElementById('l3q1hint4');
    const nextB = document.getElementById('l3q1nextButton');
    const emoji = document.getElementById('l3q1emoji');
