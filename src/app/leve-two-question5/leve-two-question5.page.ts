...
export class LeveTwoQuestion5Page implements OnInit {
  ...
  showColor(color, num){
    const qResult1 = document.getElementById('l2q5result1');
    const qResult2 = document.getElementById('l2q5result2');
    const qHint2 = document.getElementById('l2q5hint2');
    const qResult3 = document.getElementById('l2q5result3');
    const qHint3 = document.getElementById('l2q5hint3');
    const qResult4 = document.getElementById('l2q5result4');
    const qHint4 = document.getElementById('l2q5hint4');
    const nextB = document.getElementById('l2q5nextButton');
    const emoji = document.getElementById('l2q5emoji');
    const message = document.getElementById('l2q5message');
    const preUpdate = document.getElementById('l2q5numberTroph');
    const postUpdate = document.getElementById('l2q5trophUpdate');
  ...
  hideColor(option){
    const qContainer1 = document.getElementById('l2q5answer1');
    const qResult1 = document.getElementById('l2q5result1');
    const qContainer2 = document.getElementById('l2q5answer2');
    const qResult2 = document.getElementById('l2q5result2');
    const qHint2 = document.getElementById('l2q5hint2');
    const qContainer3 = document.getElementById('l2q5answer3');
    const qResult3 = document.getElementById('l2q5result3');
    const qHint3 = document.getElementById('l2q5hint3');
    const qContainer4 = document.getElementById('l2q5answer4');
    const qResult4 = document.getElementById('l2q5result4');
    const qHint4 = document.getElementById('l2q5hint4');
    const nextB = document.getElementById('l2q5nextButton');
    const emoji = document.getElementById('l2q5emoji');
