...
export class Question3Page implements OnInit {
  ...
  showColor(color, num){
    const qResult1 = document.getElementById('Q3result1');
    const qResult2 = document.getElementById('Q3result2');
    const qHint2 = document.getElementById('Q3hint2');
    const qResult3 = document.getElementById('Q3result3');
    const qHint3 = document.getElementById('Q3hint3');
    const qResult4 = document.getElementById('Q3result4');
    const qHint4 = document.getElementById('Q3hint4');
  ...
  hideColor(option){
    const qContainer1 = document.getElementById('Q3answer1');
    const qResult1 = document.getElementById('Q3result1');
    const qContainer2 = document.getElementById('Q3answer2');
    const qResult2 = document.getElementById('Q3result2');
    const qHint2 = document.getElementById('Q3hint2');
    const qContainer3 = document.getElementById('Q3answer3');
    const qResult3 = document.getElementById('Q3result3');
    const qHint3 = document.getElementById('Q3hint3');
    const qContainer4 = document.getElementById('Q3answer4');
    const qResult4 = document.getElementById('Q3result4');
    const qHint4 = document.getElementById('Q3hint4');
    const nextB = document.getElementById('nextButton3');
    const emoji = document.getElementById('emoji3');
