...
@Component({
  selector: 'app-leve-two-question2',
  templateUrl: './leve-two-question2.page.html',
  styleUrls: ['./leve-two-question2.page.scss'],
})
export class LeveTwoQuestion2Page implements OnInit {
  ...
  nextPage(){
    this.router.navigate(['leve-two-question3']);
  }
  ngOnInit() {
  }
